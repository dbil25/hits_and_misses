...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference("Reaction.count") do
      post reactions_url, params: { reaction: { author_id: @reaction.author_id, comment_id: @reaction.comment_id, type: @reaction.type } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { author_id: @reaction.author_id, comment_id: @reaction.comment_id, type: @reaction.type } }
