...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{User Team Member Role}
  ...
  # end
  #
  config.tenant_names = -> { Team.pluck :tenant_name }
...
# }
Apartment::Elevators::Subdomain.excluded_subdomains = ['www', 'hackaton2022-hits-misses', 'be31-38-141-143-30', "hitmiss"]
